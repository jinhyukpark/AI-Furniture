      ...
      <div className="relative h-screen bg-white pb-20 overflow-y-auto">
        ...
        <div className="p-6 -mt-6 bg-white rounded-t-3xl relative z-20">
          ...
          <div className="flex justify-between items-end mb-6">
            <div>
              <h2 className="text-lg font-bold">Products in this room</h2>
              <p className="text-muted-foreground text-xs">2 items selected</p>
            </div>
            <div className="text-right">
              <div className="text-xs text-muted-foreground decoration-slate-400">Total Estimate</div>
              <div className="font-bold text-xl text-primary">{(spaceConcept.totalPrice).toLocaleString()} <span className="text-sm text-muted-foreground font-normal">KRW</span></div>
            </div>
          </div>
                ...
                <div key={product.id} className="flex gap-4 p-3 rounded-2xl border border-slate-100 shadow-sm bg-white">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-2 flex items-center justify-between">
                      <div className="font-bold text-sm">{product.price.toLocaleString()} KRW</div>
                      <button className="text-xs underline text-muted-foreground">Details</button>
                    </div>
                  </div>
                </div>
              );
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" className="h-auto py-3 px-4 flex flex-col items-start gap-1 bg-slate-50 border-slate-200 hover:bg-slate-100">
                <span className="font-bold text-xs">Change Color</span>
                <span className="text-[10px] text-muted-foreground text-left leading-tight">Try a warmer tone</span>
              </Button>
              <Button variant="outline" className="h-auto py-3 px-4 flex flex-col items-start gap-1 bg-slate-50 border-slate-200 hover:bg-slate-100">
                <span className="font-bold text-xs">Budget Fit</span>
                <span className="text-[10px] text-muted-foreground text-left leading-tight">Find cheaper alt</span>
              </Button>
            </div>
          </div>
        </div>
