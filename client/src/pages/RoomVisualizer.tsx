  ...
  return (
    <MobileLayout>
      <div className="relative h-screen bg-white pb-20 overflow-y-auto">
        ...
        {/* Content */}
        <div className="p-6 -mt-6 bg-white rounded-t-lg relative z-20">
          ...
          <div className="space-y-4">
            {spaceConcept.products.map((productId) => {
              ...
              return (
                <div key={product.id} className="flex gap-4 p-3 rounded-lg border border-slate-100 shadow-sm bg-white">
